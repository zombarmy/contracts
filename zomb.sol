...
contract Zomb is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the ZOMB ERC-20 contract.
     */
    constructor() public ERC20("ZOMB", "ZOMB") {
        // Mints 1 ZOMB to contract creator for initial pool setup
    ...
    function _getTombPrice() internal view returns (uint256 _tombPrice) {
        try IOracle(tombOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("ZOMB: failed to fetch ZOMB price from Oracle");
        }
    }
    ...
    /**
     * @notice Operator mints ZOMB to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of ZOMB to mint to
