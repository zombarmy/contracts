...
contract Grave is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100,000 GRAVE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 95000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4999 ether;

    uint256 public constant VESTING_DURATION = 740 days;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("GRAVE", "GRAVE") {
        _mint(msg.sender, 1 ether); // mint 1 GRAVE for initial pools deployment
